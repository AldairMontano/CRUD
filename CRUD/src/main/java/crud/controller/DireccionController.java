...
public class DireccionController {
	...
	@GetMapping("/pasatiempos/{idDireccion}")
	...
	@PutMapping("/guardarDireccionesDTO")
	public ResponseEntity<Integer> guardarDireccion(DireccionDTO direccionDTO) {
		Integer id = 0;
		Direccion direccion2 = new Direccion(direccionDTO.getCalle(), direccionDTO.getNum_interior(), direccionDTO.getNum_exterior(), direccionDTO.getColonia(), direccionDTO.getCodigo_postal(), direccionDTO.getCiudad(), direccionDTO.getEstado());			
		try {
